---
title: Expression and regression models in primary tumors
...
predictors <- with(Data, list(
  ...
  "Sex" = sex,
  "Race" = race,
  "Tumor size: Above vs. below median" = size_group,
  "High pT stage (>pT1a)" = stage_high,
  "High Fuhrman grade (>2)" = fuhrman_high,
  "Tumor multifocality" = multifocal,
  "Invasion of surgical margins" = free_margin,
